...
function initDashboard() {
    ...
    if ($('#usersTable').length > 0) {
        console.log('Initializing users table functionality');
        
        // View User Modal Handler - Only for dashboard users table
        $(document).on('click', '#usersTable .view-btn', function() {
            console.log('View button clicked in dashboard users');
        ...
        // Edit User Modal Handler - Only for dashboard users table
        $(document).on('click', '#usersTable .edit-btn', function() {
            console.log('Edit button clicked in dashboard users');
        ...
        // Delete User Handler - Only for dashboard users table
        let deleteUserId = null;
        $(document).on('click', '#usersTable .delete-btn', function() {
            console.log('Delete button clicked in dashboard users');
