...
if ($eventId <= 0) {
    echo "<div class='alert alert-danger'>
            ...
            <strong>Error:</strong> Invalid event ID provided ($eventId). Please refresh the page and try again.
          </div>";
    exit;
}
  ...
  <div class="row">
    <div class="col-md-8">
      <table class="table table-bordered">
        ...
        <tr>
          ...
          <td>
            <span class="badge <?php echo $approval_badge; ?>">
    ...
    <div class="col-md-4 text-center">
      ...
      <div class="event-summary">
        ...
        <div class="mb-2">
          <span class="badge <?php echo $approval_badge; ?>"><?php echo htmlspecialchars($event['approval_status']); ?></span>
        </div>
        ...
        <div class="mt-3">
          <small class="text-muted">
            ...
            <span class="badge badge-secondary"><?php echo htmlspecialchars($event['creator_role'] ?? 'Unknown'); ?></span><br>
            <small class="text-muted"><?php echo htmlspecialchars($event['creator_email'] ?? ''); ?></small>
          </small>
        </div>
      </div>
    </div>
