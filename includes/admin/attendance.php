                    ...
                    <?php if ($attendance && mysqli_num_rows($attendance) > 0): ?>
                        <?php while ($record = mysqli_fetch_assoc($attendance)): ?>
                            <tr>
                                ...
                                <td>
                                    <strong><?php echo date('M d, Y', strtotime($record['event_date'])); ?></strong>
                                    <br>
                                    <small class="text-muted">
                                        <?php echo date('h:i A', strtotime($record['start_time'])); ?> - 
                                        <?php echo date('h:i A', strtotime($record['end_time'])); ?>
                                    </small>
                                </td>
                                <td>
                                    <span class="badge badge-info">
                                        <?php echo date('M d, h:i A', strtotime($record['check_in_time'])); ?>
                                    </span>
                                </td>
                                <td>
